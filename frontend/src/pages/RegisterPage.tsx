...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage(
        'Account created! Our team will review your business and approve you shortly.'
      );
      // Clear form
      setFormData({
        name: '',
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full p-10 bg-white rounded-xl shadow-lg border border-gray-100">
        {message ? (
          ...
          <>
            <div>
              ...
              <p className="mt-2 text-center text-sm text-gray-600">
                Postulate como propietario de un negocio para publicar eventos.
              </p>
            </div>
