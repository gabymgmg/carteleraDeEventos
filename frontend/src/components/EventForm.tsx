...
const EventForm = ({ initialData, onSubmit, buttonText, loading }: EventFormProps) => {
        ...
        <div className="max-w-2xl mx-auto p-4">
            ...
            <form onSubmit={handleSubmit} className="bg-white shadow-lg rounded-lg p-6 space-y-6">
                ...
                <div className="space-y-2">
                    <label className="block font-medium text-gray-700">Título del Evento</label>
                    <input
                        type="text"
                        name="title" 
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                ...
                                setFormData({ ...formData, date: `${e.target.value}T${time}:00` });
                            }}
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                ...
                                setFormData({ ...formData, date: `${date}T${e.target.value}:00` });
                            }}
                            className="w-full p-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500"
                            required
                        />
                ...
                <div className="space-y-2">
                    <label className="block font-medium text-gray-700">URL de la Imagen (Opcional)</label>
                    <input
                        type="text"
                        name="imageUrl"
